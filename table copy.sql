...
CREATE TABLE `medical_visits` (
  ...
  KEY `doctor_assigned` (`doctor_assigned`),
  KEY `fk_visit_doctor` (`assigned_doctor_id`),
  KEY `fk_visit_nurse` (`assigned_nurse_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `lab_requests` (
  ...
  KEY `visit_id` (`visit_id`),
  KEY `doctor_id` (`doctor_id`),
  KEY `fk_lab_tech` (`assigned_tech_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `prescriptions` (
  ...
  KEY `fk_phr_assign` (`assigned_phr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `referrals` (
  ...
  KEY `fk_referral_patient` (`patient_id`),
  KEY `fk_referral_visit` (`visit_id`),
  KEY `fk_referral_doctor` (`source_doctor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- --------------------------------------------------------
-- Table structure for table `visit_ward_assignments`
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table structure for table `visit_ward_assignment_requests`
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table structure for table `visit_care_team_history`
-- --------------------------------------------------------
...
ALTER TABLE `tb_followups`
  ADD CONSTRAINT `tb_followups_ibfk_1` FOREIGN KEY (`visit_id`) REFERENCES `medical_visits` (`visit_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tb_followups_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`);
...
ALTER TABLE `status_logs`
  ADD CONSTRAINT `status_logs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `status_logs_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`user_id`);

ALTER TABLE `visit_ward_assignments`
  ADD CONSTRAINT `fk_ward_visit` FOREIGN KEY (`visit_id`) REFERENCES `medical_visits` (`visit_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_ward_assigned_by` FOREIGN KEY (`assigned_by`) REFERENCES `users` (`user_id`);

ALTER TABLE `visit_ward_assignment_requests`
  ADD CONSTRAINT `fk_ward_request_visit` FOREIGN KEY (`visit_id`) REFERENCES `medical_visits` (`visit_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_ward_request_user` FOREIGN KEY (`requested_by`) REFERENCES `users` (`user_id`);

ALTER TABLE `visit_care_team_history`
  ADD CONSTRAINT `fk_care_team_visit` FOREIGN KEY (`visit_id`) REFERENCES `medical_visits` (`visit_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_care_team_staff` FOREIGN KEY (`staff_id`) REFERENCES `users` (`user_id`);
