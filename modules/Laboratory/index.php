                            ...
                            <td class="px-8 py-6 text-right">
                                <?php if ($status == 'pending'): ?>
                                    <a href="index.php?page=lab-results&req_id=<?php echo $row['request_id']; ?>"
                                        class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold text-[9px] uppercase tracking-wide hover:bg-teal-700 shadow-md transition-all active:scale-95">
