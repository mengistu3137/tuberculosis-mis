                        ...
                        <tr class="hover:bg-teal-50/20 transition-colors group">
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-800 text-sm"><?php echo $p['full_name']; ?></p>
                            ...
                            <td class="px-8 py-6 text-center">
                                <span
                                    class="px-3 py-1 bg-white border border-gray-100 rounded-lg text-[10px] font-semibold text-gray-500 uppercase"><?php echo $p['age']; ?>Y
